...
const PoliticasDePrivacidade = () => {
    ...
    O Nutrafity coleta informações pessoais limitadas, como nome, endereço de e-mail e informações de contato, quando você se registra em nosso site ou utiliza nossos serviços. Também podemos coletar informações de uso do site, como páginas visitadas e interações realizadas.<br/><br/>

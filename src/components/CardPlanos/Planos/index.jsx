            ...
            <DivPai>
                ...
                <DivFormPai>
                    ...
                    <DivForm>
                        ...
                        <CardPlano tituloPlano={'Dieta'} frequencia={'1 dieta'} valorPlano={'14,90'} numDietas={'1'} link={`../pixpage`}   adicionalAnual={false} avulso={true} linkPagamento={`https://pay.kiwify.com.br/PHko4N7?utm_content=${localStorage.getItem('@UserId:Nutrafity')}&src=1`}/>
